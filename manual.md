...
### General
AIFS is a text format for representation of the [Iterated Function Systems](https://en.wikipedia.org/wiki/Iterated_function_system) (IFS).\
...
When you save a rendered image to PNG format, the program automatically saves all parameters (IFS, palette, location, etc) inside the PNG, and you can load such PNG to the program to restore your workspace.
