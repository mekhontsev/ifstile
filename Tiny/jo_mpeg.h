...
intptr_t encode_mpeg(
	unsigned char *mem, 
	const unsigned char *rgbx, 
	int width, 
	int height, 
	int fps) 
{
	...
	if(fps <= 24) put1b(0x12, &mem);
	else if(fps <= 25) put1b(0x13, &mem);
	else if(fps <= 30) put1b(0x15, &mem);
	else if(fps <= 50) put1b(0x16, &mem);
	else put1b(0x18, &mem); // 60fps
